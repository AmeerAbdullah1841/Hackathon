...
function HexDumpMessagePageContent() {
  ...
  const handleSubmit = async () => {
    ...
    await saveSubmission();
    setSubmitted(true);
    alert("Submission successful! Great work on the hex dump decoding.");
  };

  return (
    <ChallengeLayout
      challengeTitle="Hex Dump Message"
      difficulty="EASY"
      points={100}
    >
        ...
        {showTutorial && (
          <div className="mb-6 rounded-2xl border-2 border-blue-200 bg-blue-50 p-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <h4 className="mb-3 font-semibold text-blue-700">How to Convert Hex to ASCII:</h4>
                <ol className="ml-4 list-decimal space-y-2 text-sm text-slate-700">
                  <li>Hex (hexadecimal) uses 0-9 and A-F to represent bytes</li>
                  <li>Each pair of hex digits represents one byte (0-255)</li>
                  <li>Convert each hex pair to its decimal value</li>
                  <li>Map decimal values to ASCII characters</li>
                  <li>Combine all characters to form the message</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>Online: rapidtables.com, hex-to-ascii.com</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>Python: bytes.fromhex('hex_string').decode('ascii')</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>Linux: echo 'hex_string' | xxd -r -p</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>CyberChef: From Hex operation</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-2xl bg-white p-6 shadow">
          <div className="mb-6">
            ...
            <p className="text-slate-700">
              Convert the hexadecimal string to ASCII to reveal the flag. The hex string may contain spaces or be continuous. 
          ...
          <div className="mb-6 rounded-xl border-2 border-purple-200 bg-purple-50 p-4">
            ...
            <div className="space-y-4">
              <div>
                <p className="mb-2 text-sm font-semibold text-purple-800">Hexadecimal String:</p>
                <code className="block rounded-lg bg-white p-3 text-sm font-mono break-all">
                  666c61677b6865785f64756d705f6465636f6465727d
                </code>
              </div>
              <div className="mt-4 rounded-lg bg-yellow-50 border border-yellow-200 p-3">
                <p className="text-xs text-yellow-800">
                  <strong>Hint:</strong> Convert each pair of hex digits to its ASCII character. For example, 66 = 'f', 6c = 'l', 61 = 'a', 67 = 'g'.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                rows={6}
                placeholder="Describe your hex to ASCII conversion approach..."
              />
...
export default function HexDumpMessagePage() {
  return (
    <Suspense fallback={

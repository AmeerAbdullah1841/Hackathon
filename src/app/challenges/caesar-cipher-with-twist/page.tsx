...
function CaesarCipherWithTwistPageContent() {
  ...
  const handleSubmit = async () => {
    ...
    await saveSubmission();
    setSubmitted(true);
    alert("Submission successful! Great work on the caesar cipher.");
  };

  return (
    <ChallengeLayout
      challengeTitle="Caesar Cipher With Twist"
      difficulty="HARD"
      points={200}
    >
          ...
          <div className="mb-6 rounded-2xl border-2 border-blue-200 bg-blue-50 p-6">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="flex items-center gap-2 text-xl font-bold">
                ...
                Modified Caesar Cipher Tutorial
              </h3>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <h4 className="mb-3 font-semibold text-blue-700">Modified Caesar Cipher:</h4>
                <ul className="space-y-2 text-sm text-slate-700">
                  <li>Standard Caesar shifts all letters by the same amount</li>
                  <li>Modified versions may shift differently for different positions</li>
                  <li>Could use different shifts for uppercase/lowercase</li>
                  <li>May include numbers or special characters</li>
                  <li>Try different shift values systematically</li>
                </ul>
              </div>

              <div>
                <h4 className="mb-3 font-semibold text-green-700">Decryption Techniques:</h4>
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>Try all shift values (1-25)</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>Look for flag format: {'flag{...}'}</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>Frequency analysis</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500">✓</span><span>Online tools: dcode.fr, cryptii.com</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-2xl bg-white p-6 shadow">
          <div className="mb-6">
            ...
            <p className="text-slate-700">
              Decrypt the message to find the flag. This uses a modified Caesar cipher where the shift may vary or have special rules. 
          ...
          <div className="mb-6 rounded-xl border-2 border-purple-200 bg-purple-50 p-4">
            ...
            <div className="space-y-4">
              <div>
                <p className="mb-2 text-sm font-semibold text-purple-800">Encrypted Message:</p>
                <code className="block rounded-lg bg-white p-3 text-sm font-mono">
                  gmbh{'{'}fqh_apmxqhgq_ue_adaeuzs{'}'}
                </code>
              </div>
              <div>
                <p className="mb-2 text-sm font-semibold text-purple-800">Cipher Details:</p>
                <p className="text-sm text-slate-700">This uses a modified Caesar cipher where:</p>
                <ul className="ml-4 mt-1 list-disc text-sm text-slate-700">
                  <li>Letters are shifted by a fixed amount</li>
                  <li>Curly braces and underscores remain unchanged</li>
                  <li>The shift value needs to be determined</li>
                </ul>
              </div>
              <div className="mt-4 rounded-lg bg-yellow-50 border border-yellow-200 p-3">
                <p className="text-xs text-yellow-800">
                  <strong>Hint:</strong> Try a backward shift. If 'g' should be 'f', that's a shift of -1. Apply this shift to all letters.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                rows={6}
                placeholder="Describe your decryption approach..."
              />
...
export default function CaesarCipherWithTwistPage() {
  return (
    <Suspense fallback={
      ...
      <CaesarCipherWithTwistPageContent />
    </Suspense>
  );
}
